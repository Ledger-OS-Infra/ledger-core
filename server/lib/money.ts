/** Ledger-Core stores NGN amounts in kobo — 1 NGN = 100 kobo. */
...
/** Convert whole naira to kobo for storage. E.g. ₦1,500 → 150_000. */
...
/** Stored and API amount fields are kobo integers. */
